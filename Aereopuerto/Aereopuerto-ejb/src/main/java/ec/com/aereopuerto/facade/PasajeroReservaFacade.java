 ...
 */
@Stateless
public class PasajeroReservaFacade extends AbstractFacade<PasajeroReserva> implements PasajeroReservaFacadeLocal {
    ...
    public PasajeroReservaFacade() {
        super(PasajeroReserva.class);
    }
